...
<body>
    ...
    <nav class="navbar navbar-light bg-light navbar-collapse-lg">
        <div class="container-fluid justify-content-end">
            ...
            <button class="bt btn btn-secondary" type="button" data-toggle="collapse"
                data-target="#navbarSupportedContent"><i class="bi bi-chevron-left">
    ...
    <div class="container-fluid">
        <div class="row gx-0">
            ...
            <div class="col-9" id="recipeListPart">
                <div>
                    <h2 class="titleList">List of recipes</h2>
                    <div class="buttons">
